...
public class JavaRucImplementationFileMetaStructure extends FileMetaStructure {
    public JavaRucImplementationFileMetaStructure(ImplementationsFolderMetaStructure implementationsFolderMetaStructure, String name) {
        super(
