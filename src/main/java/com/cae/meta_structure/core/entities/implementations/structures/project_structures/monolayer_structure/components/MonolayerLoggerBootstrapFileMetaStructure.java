...
public class MonolayerLoggerBootstrapFileMetaStructure extends FileMetaStructure {

    public MonolayerLoggerBootstrapFileMetaStructure(FolderMetaStructure parent) {
        super(
                parent,
                "LoggerBootstrap",
                TextCase.PASCAL,
