...
public class MonolayerCoreFolderMetaStructure extends FolderMetaStructure {

    public MonolayerCoreFolderMetaStructure(FolderMetaStructure parent) {
        super(
                parent,
                "core",
                TextCase.SNAKE
    ...
    protected List<FolderMetaStructure> defineNeededFolders() {
        return List.of(
                new MonolayerEntitiesFolderMetaStructure(this),
