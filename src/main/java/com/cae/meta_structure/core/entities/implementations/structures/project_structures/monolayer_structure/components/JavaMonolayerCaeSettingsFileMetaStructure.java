...
public class JavaMonolayerCaeSettingsFileMetaStructure extends FileMetaStructure {

    public JavaMonolayerCaeSettingsFileMetaStructure(FolderMetaStructure parent) {
        super(
                parent,
                "cae-settings",
                TextCase.KEBAB,
