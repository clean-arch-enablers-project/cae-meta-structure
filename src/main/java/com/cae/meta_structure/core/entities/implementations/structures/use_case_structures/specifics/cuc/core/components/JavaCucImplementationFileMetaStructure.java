package com.cae.meta_structure.core.entities.implementations.structures.use_case_structures.specifics.cuc.core.components;
...
public class JavaCucImplementationFileMetaStructure extends FileMetaStructure {
    public JavaCucImplementationFileMetaStructure(FolderMetaStructure implementationsFolderMetaStructure, String name) {
        super(
