...
public class JavaInputFileMetaStructure extends FileMetaStructure {

    public JavaInputFileMetaStructure(FolderMetaStructure inputsFolderMetaStructure, String useCaseName) {
        super(
