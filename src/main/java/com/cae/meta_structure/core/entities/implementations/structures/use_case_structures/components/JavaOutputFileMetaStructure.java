...
public class JavaOutputFileMetaStructure extends FileMetaStructure {

    public JavaOutputFileMetaStructure(FolderMetaStructure outputsFolderMetaStructure, String useCaseName) {
        super(
